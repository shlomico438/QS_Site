...
window.translations = {
    he: {
        ...
        auth_oauth_callback_failed_private: "ההתחברות מתעכבת בגלישה בסתר. אם לא התחברתם, לחצו שוב על «התחבר» — לרוב זה מסיים מיד.",
    ...
    en: {
        ...
        auth_oauth_callback_failed_private: "Sign-in is slow in private browsing. If you’re not signed in, tap Connect again — it usually completes immediately.",
