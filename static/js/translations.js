...
window.translations = {
    he: {
        ...
        guest_trial_insufficient_msg: "ניסיון אורח מוגבל ל-{balance} דקות. הקובץ דורש {required} דקות. העלו קובץ קצר יותר, או הירשמו ורכשו דקות.",
        ...
        tab_doc: "תמלול",
        tab_summary: "סיכום",
        transcript_cleanup_in_progress: "משפרים את קריאות התמלול…",
        ...
        magic_link_send_failed: "לא הצלחנו לשלוח קישור לאימייל הזה. נסו התחברות עם Google, או בדקו את תיבת הספאם.",
        magic_link_wait: "יש להמתין כדקה לפני בקשת קישור נוסף.",
        email_signup_blocked: "לא ניתן להשתמש בכתובת אימייל זו. אנא השתמש בכתובת אימייל קבועה.",
        ...
        auth_ios_private_sign_in: "בגלישה בסתר ההתחברות עלולה לקחת יותר זמן. אחרי Google — המתינו בדף הזה עד שהחלון נסגר.",
        auth_oauth_completing: "משלימים התחברות…",
        auth_oauth_callback_failed: "ההתחברות לא הושלמה. נסו שוב.",
        auth_oauth_callback_failed_private: "ההתחברות לא הושלמה. נסו שוב — אם כבר התחברתם, לחצו «התחבר» פעם נוספת.",
        ...
        medical_mic_title: "מיקרופון",
        medical_mic_device_label: "מיקרופון",
        medical_mic_test: "בדיקת מיקרופון",
        medical_mic_testing: "בודק…",
        medical_mic_stop_test: "עצור בדיקה",
        medical_mic_close: "סגור",
        medical_mic_permission_denied: "אין הרשאה למיקרופון. אשרו גישה בדפדפן ונסו שוב.",
        medical_mic_no_devices: "לא נמצאו מיקרופונים.",
        medical_mic_default_device: "ברירת מחדל של המערכת",
        medical_mic_saved_default: "המיקרופון הזה נשמר כברירת המחדל להקלטות.",
        medical_mic_device_failed: "לא ניתן לפתוח את המיקרופון שנבחר. בחרו מיקרופון אחר ונסו שוב.",
        ...
        medical_enter_newline_tip: "טיפ — אפשר ללחוץ על Enter כדי לעבור שורה, ו-Shift+Enter כדי לפתוח תיבה חדשה.",
        medical_language_pause_tip: "במעבר בין שפות — עצרו כשתי שניות.",
        medical_stream_lang_label: "שפת תמלול",
        medical_stream_lang_aria: "שפת תמלול חי",
        ...
        medical_guest_try_title: "שמרו על העבודה שלכם",
        medical_guest_try_message: "כדי למנוע אובדן נתונים וכדי שתוכלו להעתיק את התוצאה, עליכם להיות מחוברים לחשבון. ההרשמה היא בחינם.",
        medical_guest_try_register: "הרשמה בחינם",
        medical_guest_try_continue: "המשך במצב צפייה בלבד",
        medical_guest_try_unsaved: "התמלול זמין במסך — כדי לשמור אותו יש להירשם.",
        ...
        medical_copy: "העתק",
        medical_copy_all: "העתק הכל",
        medical_fix_typos: "התאמה רפואית",
        medical_fix_typos_tooltip: "ממיר מונחים רפואיים שנכתבו פונטית בעברית לאיות האנגלי הנכון, ומתקן שגיאות כתיב",
        medical_fixing_typos: "מבצע התאמה רפואית…",
        medical_undo_typos: "בטל",
        medical_typos_fixed: "התמלול נוקה.",
        medical_typos_undone: "התיקונים בוטלו.",
        medical_typos_unchanged: "לא נמצאו שגיאות לתיקון.",
        medical_typos_fix_failed: "ניקוי התמלול נכשל.",
        medical_typos_gpt_disabled: "תיקון GPT כבוי בשרת.",
        medical_no_text_to_fix: "אין תמלול לניקוי.",
        medical_no_text_to_copy: "אין טקסט להעתקה",
        medical_stream_network_blocked: "החיבור החי נחסם ברשת זו. נסו רשת אחרת או בקשו מהמחלקה לאפשר WebSocket/polling ל-getquickscribe.com.",
        ...
        pipeline_vocal_separation: "הפרדת קול",
        ...
        upload_music_mode_short: "מוזיקה",
        upload_music_mode_desc: "מומלץ לשירים או לקבצים עם מוזיקת רקע דומיננטי",
        upload_music_mode_slow_notice: "העיבוד לוקח זמן רב יותר משמעותית ממצב דיבור רגיל.",
        upload_music_mode_vocal_separation_notice: "המערכת מפרידה את הקול מהמוזיקה ברקע כדי לשפר את דיוק התמלול בשירים ובהקלטות עם מוזיקה.",
        upload_music_mode_enable: "הפעל",
    ...
    en: {
        ...
        guest_trial_insufficient_msg: "Guest try is limited to {balance} minutes. This file needs {required} minutes. Upload a shorter file, or sign up and buy minutes.",
        ...
        tab_doc: "Transcript",
        tab_summary: "Summary",
        transcript_cleanup_in_progress: "Improving transcript readability…",
        ...
        magic_link_send_failed: "We could not send a sign-in link to that email. Try Google sign-in, or check spam.",
        magic_link_wait: "Please wait about a minute before requesting another link.",
        email_signup_blocked: "This email address cannot be used. Please use a permanent email address.",
        ...
        auth_ios_private_sign_in: "Private browsing can be slower to sign in. After Google, wait on this page until the modal closes.",
        auth_oauth_completing: "Completing sign-in…",
        auth_oauth_callback_failed: "Sign-in could not be completed. Please try again.",
        auth_oauth_callback_failed_private: "Sign-in could not be completed. Try again — if you already signed in with Google, tap Connect once more.",
        ...
        medical_mic_title: "Microphone",
        medical_mic_device_label: "Microphone",
        medical_mic_test: "Test microphone",
        medical_mic_testing: "Testing…",
        medical_mic_stop_test: "Stop test",
        medical_mic_close: "Close",
        medical_mic_permission_denied: "Microphone permission denied. Allow access in the browser and try again.",
        medical_mic_no_devices: "No microphones found.",
        medical_mic_default_device: "System default",
        medical_mic_saved_default: "This microphone is saved as your default for recordings.",
        medical_mic_device_failed: "Could not open that microphone. Choose another and try again.",
        ...
        medical_enter_newline_tip: "Tip — press Enter for a new line, Shift+Enter to open a new box.",
        medical_language_pause_tip: "When switching languages, pause about 2 seconds.",
        medical_stream_lang_label: "Transcription language",
        medical_stream_lang_aria: "Live transcription language",
        ...
        medical_guest_try_title: "Protect your work",
        medical_guest_try_message: "To prevent data loss and so you can copy the result, you must be logged into an account. Registration is free.",
        medical_guest_try_register: "Free registration",
        medical_guest_try_continue: "Continue in view-only mode",
        medical_guest_try_unsaved: "Transcript is on screen — register to save your work.",
        ...
        medical_copy: "Copy",
        medical_copy_all: "Copy all",
        medical_fix_typos: "Medical adaptation",
        medical_fix_typos_tooltip: "Converts medical terms written phonetically in Hebrew to the correct English spelling, and fixes typos",
        medical_fixing_typos: "Adapting medically…",
        medical_undo_typos: "Undo",
        medical_typos_fixed: "Transcript cleaned.",
        medical_typos_undone: "Corrections undone.",
        medical_typos_unchanged: "No typos found to fix.",
        medical_typos_fix_failed: "Could not clean transcript.",
        medical_typos_gpt_disabled: "GPT correction is disabled on the server.",
        medical_no_text_to_fix: "No transcript to clean.",
        medical_no_text_to_copy: "No text to copy",
        medical_stream_network_blocked: "Live connection was blocked on this network. Try another network, or ask IT to allow WebSocket/polling to getquickscribe.com.",
        ...
        pipeline_vocal_separation: "Vocal separation",
        ...
        upload_music_mode_short: "Music",
        upload_music_mode_desc: "Recommended for songs or audio with dominant background music.",
        upload_music_mode_slow_notice: "Processing takes significantly longer than standard speech mode.",
        upload_music_mode_vocal_separation_notice: "The system separates vocals from background music to improve transcription accuracy on songs and music-heavy recordings.",
        upload_music_mode_enable: "Enable",
