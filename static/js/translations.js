...
window.translations = {
    he: {
        ...
        medical_choose_plan: "בחירת מסלול",
        medical_plan_billing: "מסלול וחיוב",
        medical_usage_trial_days: "ניסיון: {days} ימים נותרו",
        medical_usage_hours_remaining: "{remaining} מתוך {included} שעות נותרו",
        medical_usage_overage: "{used} שעות נוצלו · {overage} שעות נוספות",
        medical_pricing_title: "מסלולים פשוטים לפי שעות תמלול",
        medical_pricing_modal_title: "בחירת מסלול רפואי",
        medical_pricing_modal_intro: "בחרו את מכסת שעות התמלול המתאימה לכם.",
        medical_plan_price_starter: "₪149",
        medical_plan_price_professional: "₪249",
        medical_plan_price_clinic: "₪699",
        medical_plan_per_month: "/ חודש",
        medical_plan_hours_starter: "30 שעות תמלול בחודש",
        medical_plan_hours_professional: "60 שעות תמלול בחודש",
        medical_plan_hours_clinic: "180 שעות תמלול בחודש",
        medical_plan_seats_clinic: "עד 5 אנשי מקצוע",
        medical_plan_recommended: "מומלץ",
        medical_plan_select_starter: "בחירת Starter",
        medical_plan_select_professional: "בחירת Professional",
        medical_plan_select_clinic: "בחירת Clinic",
        medical_overage_note: "תמלול נוסף מעבר למכסה: ₪6 לשעה.",
        medical_pricing_checking_plan: "בודקים את פרטי המסלול…",
        ...
        medical_saving_recording: "שומרים את ההקלטה…",
        ...
        medical_stream_connecting: "מתחבר לתמלול חי…",
        medical_stream_listening: "מאזין…",
        medical_stream_parked: "עדיין מקשיבים — אפשר להמשיך לדבר",
        medical_stream_resuming: "מתחדש לתמלול… אפשר להמשיך לדבר",
    ...
    en: {
        ...
        medical_choose_plan: "Choose plan",
        medical_plan_billing: "Plan & billing",
        medical_usage_trial_days: "Trial: {days} days left",
        medical_usage_hours_remaining: "{remaining} of {included} hours remaining",
        medical_usage_overage: "{used} hours used · {overage} additional hours",
        medical_pricing_title: "Simple plans by transcription hours",
        medical_pricing_modal_title: "Choose a medical plan",
        medical_pricing_modal_intro: "Choose the transcription hour quota that fits your practice.",
        medical_plan_price_starter: "$75",
        medical_plan_price_professional: "$125",
        medical_plan_price_clinic: "$350",
        medical_plan_per_month: "/ month",
        medical_plan_hours_starter: "30 transcription hours per month",
        medical_plan_hours_professional: "60 transcription hours per month",
        medical_plan_hours_clinic: "180 transcription hours per month",
        medical_plan_seats_clinic: "Up to 5 professionals",
        medical_plan_recommended: "Recommended",
        medical_plan_select_starter: "Choose Starter",
        medical_plan_select_professional: "Choose Professional",
        medical_plan_select_clinic: "Choose Clinic",
        medical_overage_note: "Additional transcription beyond quota: $3 per hour.",
        medical_pricing_checking_plan: "Checking plan details…",
        ...
        medical_saving_recording: "Saving recording…",
        ...
        medical_stream_connecting: "Connecting live transcription…",
        medical_stream_listening: "Listening…",
        medical_stream_parked: "Still listening — you can keep talking",
        medical_stream_resuming: "Resuming transcription… you can keep talking",
